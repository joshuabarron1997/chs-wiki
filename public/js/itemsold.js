...
//#region glory shop
{
    ...
    filters: ['strength','pvp','glory','block','scaling','active ability','stackable', 'earth']
},
{
    ...
    glory: 10000,
    exp: 0,
    description: "<span class = 'effects'>Effects</span><br><span class 'indent'>+200 agility.<br>+5 pvp bonus.<br>+20 evasion.<br>+15 agility for every level the hero has.</span><br><br>[<span class = 'unique'>Unique</span>]<br><span class = 'indent'><span class = 'abilities'>Abilities</span><br>Deals 50% of the Hero's agility in damage per second toa random nearby unit (hero priority) for a short period of time when used.<br><span class = 'grayHint'>Damage per second increases by 50% for every Ancient Dagger carried.</span></span><br><br><span class = 'range'>Range:</span> 600<br><span class = 'duration'>Duration:</span> 10 seconds<br><span class = 'cooldown'>Cooldown:</span> 30 seconds",
    shop: "Glory Shop",
    position: 2,
    id: '',
    filters: ['agility', 'pvp', 'glory', 'evasion', 'scaling', 'active ability', 'stackable', 'poison','unpurgable']
},
//#endregion
//#region summon buffs
//#endregion
