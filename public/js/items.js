...
},
{
    ...
    glory: 1500,
    exp: 0,
    description: "<span class = 'effects'>Effects</span><br><span class = 'indent'>Increases the Hero's hit point regeneration by 150.",
    shop: "Arena Buffs I",
    position: 3,
    id: '',
...
},
{
    ...
    position: 3,
    id: '',
    filters: ['inteligence', 'pvp', 'glory', 'magic power', 'scaling', 'active ability', 'stackable']
},
{
    ...
    position: 4,
    id: '',
    filters: ['physical', 'strength','agility','inteligence','passive ability']
},
{
...
},
{
    ...
    glory: 10000,
    exp: 0,
    description: "<span class = 'effects'>Effects</span><br><span class = 'indent'>+800 block.</span><br><br>[<span class = 'unique'>Unique</span>]<br><span class = 'abilities'>Abilities</span><br><span class = 'indent'>When the Hero takes magic damage it temporarily gains block equal to 20% of the damage taken.<br><span class = 'grayHint'>Does not stack with itself.</span><br><br><span class = 'duration'>Duration:</span> 5 seconds</span>",
    shop: "Glory Shop",
    position: 8,
    id: '',
...
},
{
    ...
    glory: 0,
    exp: 0,
    description: "<span class = 'effects'>Effects</span><br><span class = 'indent'>+25 armor.</span><br><br>[<span class = 'unique'>Unique</span>]<br><span class = 'abilities'>Abilities</span><br><span class = 'indent'>Reduces the attack damage of nearby enemy creeps by 33% when used.<br><span class = 'cooldown'>Cooldown:</span> 30 seconds.",
    shop: "PVE Shop I",
    position: 8,
    id: '',
...
},
{
    ...
    glory: 0,
    exp: 0,
    description: "<span class = 'effects'>Effects</span><br><span class = 'indent'>-500 attack damage.<br>+10 armor.</span><br>[<span class = 'unique'>Unique</span>]<br><span class = 'abilities'>Abilities</span><br><span class = 'indent'>When used it reduces the Hero's agility by 300% and increases it's attack damage by 600% of its agility for 15 seconds.<br><span class = 'cooldown'>Cooldown:</span> 50 Seconds</span>",
    shop: "Item Shop V",
    position: 2,
    id: '',
    filters: ['attack damage','active ability','scaling','armor','agility','anti physical']
},
{
...
},
{
    ...
    glory: 0,
    exp: 0,
    description: "<span class = 'effects'>Effects</span><br><span class = 'indent'>+800 attack damage.<br>+50 agility<br>+10 evasion</span><br><br>[<span class = 'unique'>Unique</span>]<br><span class = 'abilities'>Abilities</span><br><span class = 'indent'>When dealing <span class = 'physical'>physical damage</span> the Hero teleports next to the target<br><span class = 'grayHint'>Reduces the cooldown of the Blink Strike ability by 50%.</span></span>",
    shop: "Item Shop VI",
    position: 8,
    id: '',
